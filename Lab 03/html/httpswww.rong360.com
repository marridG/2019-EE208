                ...
                <div id="contact_tosubmit_part">
                    <div id="vcode_part" >
                        <div class="register-line clearfix">
                            ...
                            <div class="picvcode"><img onclick="$('#verifyPic')[0].src += '1';" width="95" height="36" id="verifyPic" src="/vcode/create?type=contact_banker&t=1570274812"/></div>
                        </div>
                    </div>
                    <div id="sms_part">
                        <div class="register-line">
    ...
    <div class="ask-all">
        ...
        <div class="content clearfix">
            ...
            <ul class="clearfix ask-ul">
                                ...
                                <li><a href="https://www.rong360.com/ask/view/31u53two6" target="_blank" >• 有没有什么贷款可以不看征信的</a></li>
                                <li>
...
function get_ra()
{
    var ra_pid = "75db859e4b5b850249d2b00958ea544f";
    if ($('#ra_pid').length > 0)
    {
        ra_pid = $('#ra_pid').val();
    }
    ...
    return '//g.rong360.com/u.gif?rid=' + ra_gc('RONGID') + '&access_id=' + 'ebhuem0it0sc2lp8elmnspfb03' + '&ca=site/index&tpl=index/release/page/index.tpl&url=' + url + '&rf=' + rf + '&host=' + host + '&city=shanghai&pid=' + ra_pid + '&uf=i_c83ce99b05ee00862ae4e330c8e30b5c&abclass=' + abclass + '&ga_csr=' + encodeURIComponent(vals.utmcsr) + '&ga_ccn=' + encodeURIComponent(vals.utmccn) + '&ga_cmd=' + encodeURIComponent(vals.utmcmd) + '&ga_ctr=' + encodeURIComponent(vals.utmctr) + '&rtm=' + encodeURIComponent($.cookie('__rtm')) + '&ext=' +  encodeURIComponent(ext_str) + '&page_name=' + encodeURIComponent(page_name) + "&t=" + (new Date().getTime())+'&channel=daikuan_pc';
};
$(function(){
...
<script>
	...
	$(function(){
		var tags = $("[data-log-event]"),
			vo = {
				//rongid
				"rid": "9b9f67337de362f7f532aceca1bd2463",
				//sessionid
				"access_id": "",
				//当前页面的pagename
				"page_name": "page_name=homepage",
