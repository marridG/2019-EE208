...
<header class="header ">
    ...
    <div class="tulu margin">
        ...
        <ul class="tlUl">
                    ...
                    <li onclick="browserRedirect('295')">
                        <img class="img-rounded" src="http://imagecdn.chengxuan.com//images/auction_cover/31_295.jpg" >
                        <p>中国书画（一）</p>
                    </li>
                    ...
                    <li onclick="browserRedirect('448')">
                        <img class="img-rounded" src="http://imagecdn.chengxuan.com//images/auction_cover/31_448.jpg" >
                        <p>瓷器工艺品</p>
                    </li>
                
            
                
                    <li onclick="browserRedirect('378')">
                        <img class="img-rounded" src="http://imagecdn.chengxuan.com//images/auction_cover/31_378.jpg" >
                        <p>现当代艺术</p>
                    </li>
