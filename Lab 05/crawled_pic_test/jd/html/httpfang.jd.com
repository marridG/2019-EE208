...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="//static.360buyimg.com/finance/consumer/buyHouseBaitiao/index/4.0.0/css/newindex.css">
    <script>
        window.jrBase = {
            navId: 'nav-baitiao',
            navSubId: '',
...
<!--header end-->
<!--banner start-->
<div class="banner" id="ceng1">
    <ul class="banner-list pic-layer" node-type="bg" style="">
        <li class=""></li>
        <li class="hide"></li>
        <li class="hide"></li>
    </ul>
    <div class="bigTitBox ">
                                    <h2 class="zoomIn">家 装 打 白 条</h2><!--title大标题文案-->
                <p class="zoomIn">京 东 金 融 推 出 用 于 装 修 的 分 期 信 用 贷 款 服 务</p><!--slogan副标题文案-->
                    
        <div class="b-t-b-btnBox zoomIn">
            <a href="javascript:void(0);" class="zx-Btn"> <i></i><!--我要装修--></a>
            <a href="//btp.jd.com/query/queryLoanTop" class="hk-Btn"><i></i><!--立即还款--></a>
        </div>
        <!--<a href="javascript:void(0);" class="prev-btn"></a>
        <a href="javascript:void(0);" class="next-btn"></a>-->
    </div>

    <p class="pledge-banner-bar" node-type="bar">
...
<!--banner end-->
<!--优势-->
<div class="advantageBox " id="ceng2">

    <div class="ad-center hide  animated">
        <div class="ysl"></div>
        <div class="ad-center-child  animated hinge">
                                                <h3 class="">
                        <!--零首付低利率 最高可贷<span>50</span>万 最长可分<span>36</span>期-->
                        <img src="//img30.360buyimg.com/jr_image/jfs/t15430/239/2657009220/7935/1a73e20c/5ab0bd03N7742e054.png" alt="">
                    </h3>
                    <p class="">
                        <!--家装白条是京东金融推出的装修分期信用贷款服务。与业内优质装修企业合作，用于预支付用户购买装修服务（含装修人工服务+装修材料）的款项，用户分期还款即可。-->
                        <img src="//img30.360buyimg.com/jr_image/jfs/t17320/228/903931283/8296/d839fa24/5ab0bd41N2440d9b0.png" alt="">
                    </p>
                                                                            <!--便捷快省-->
                    <div class="kjbs">
                        <img src="//img30.360buyimg.com/jr_image/jfs/t15346/255/2653627531/13293/1faa6ef8/5ab0c1f1Nef9266bd.png" alt="">
                    </div>
...
<!--步骤-->
<div class="stepBox ">
    <div class="stepList clearfix ">
        <div class="stepTit fl">
            <!--申请流程 showZXProductVoListM_apply-->
        </div>
                                    <div class="stepBox-parent fl">
                    <img src="//img30.360buyimg.com/jr_image/jfs/t14338/303/2681392622/10222/3239c5b1/5ab0f983N5c262c84.png" alt="">
                </div>
                        </div>
</div>
<!--步骤 end-->
<!--合作商户 showZXProductVoListM-->
<div class="businessBox" id="ceng3">
    <div class="b-center  hide animated fadeInDown">
        <div class="b-center-box">
                                <ul class="clearfix">
                                        <li class="fl ">
                            <div class="b-logo">
                                <img src="//img30.360buyimg.com/jr_image/jfs/t18595/195/909981140/1615/6bfe8523/5ab0cd5fN1a77e9a8.png" alt=""><!--logo链接-->
                            </div>
                            <div class="b-msg">
                                    因为专注 所以专业<!--二维码上方文案-->
                            </div>
                            <div class="b-ewm">
                                <img src="//img30.360buyimg.com/jr_image/jfs/t17842/309/912179210/13996/afff2314/5ab0f9e0N1cae82af.jpg" alt=""><!--二维码链接-->
                            </div>
                            <p>扫码了解详情</p>
                        </li>
                                                            <li class="fl ">
                            <div class="b-logo">
                                <img src="//img30.360buyimg.com/jr_image/jfs/t17473/100/906274312/3379/cb1ba304/5ab0ce4bN660ac4b3.jpg" alt=""><!--logo链接-->
                            </div>
                            <div class="b-msg">
                                    一站式装修<!--二维码上方文案-->
                            </div>
                            <div class="b-ewm">
                                <img src="//img30.360buyimg.com/jr_image/jfs/t15721/225/2525479556/14329/e9c46dbd/5ab0ce4bNd927d0a2.jpg" alt=""><!--二维码链接-->
                            </div>
                            <p>扫码了解详情</p>
                        </li>
                                                        </ul>
        ...
        <div class="pageBox" id="pagination">
            <!--<a href="javascript:void(0);" class="prev disBtn" page-data="prev">← 上一页</a>-->
            <!--<a href="javascript:void(0);" class="cur"  page-data="1">1</a>-->
            <!--<a href="javascript:void(0);" page-data="2">2</a>-->
            <!--<a href="javascript:void(0);" page-data="3">3</a>-->
            <!--<span page-data="more">...</span>-->
            <!--<a href="javascript:void(0);" page-data="6">6</a>-->
            <!--<a href="javascript:void(0);" class="next" page-data="next">下一页 →</a>-->
        </div>
    </div>
</div>
<!--商户 end-->
<!--常见问题 showZXProductVoListB-->
<div class="questionBox" id="ceng4">
    <div class="question-center w2 hide animated">
                                            <div class="question-img img_1" >
                    <img src="//img30.360buyimg.com/jr_image/jfs/t19198/19/1788658861/52518/38299f49/5ad86465N972cce06.png" alt=""><!--图片链接-->
                </div>
                    
        
        <div class="pageBox" id="pagination2">
            <!--<a href="javascript:void(0);" class="prev disBtn" page-data="prev">← 上一页</a>-->
            <!--<a href="javascript:void(0);" class="cur"  page-data="1">1</a>-->
            <!--<a href="javascript:void(0);" page-data="2">2</a>-->
            <!--<a href="javascript:void(0);" page-data="3">3</a>-->
...
<div class="floor-list">
    ...
    <div class="floorNum">
        <a href="javascript:void(0);" class="num1 active" node-type='floor'></a>
        <a href="javascript:void(0);" class="num2" node-type='floor'></a>
        <a href="javascript:void(0);" class="num3" node-type='floor'></a>
        <a href="javascript:void(0);" class="num4" node-type='floor'></a>
    </div>
...
<script src="//static.360buyimg.com/finance/consumer/buyHouseBaitiao/index/4.0.0/js/main.js"></script>
<script src="//static.360buyimg.com/finance/consumer/buyHouseBaitiao/index/4.0.0/js/page.js"></script>
...
<script>
    //banner轮播图showZXProductVoListT_banner
    seajs.use("tools/newindex", function(fun) {
        new fun.newbanner({
            parent: $("#ceng1"),
            imgList: [
                                        {
                                            src: "//img30.360buyimg.com/jr_image/jfs/t19285/14/905191840/315189/cdc1b7a4/5ab0b367Nb3bd2e6f.jpg"
                                                      },{
                                                                     src: "//img30.360buyimg.com/jr_image/jfs/t15511/218/2618719789/381762/7bb5fda8/5ab0b8deNd9934ae0.jpg"
                                                      },{
                                                                     src: "//img30.360buyimg.com/jr_image/jfs/t15028/27/2649697192/277272/39c9d272/5ab0b8ddN68ef2ebc.jpg"
                                                      }
                                                                         ]
        });
    })
...
<script>
    $(function() {
        var _index = 0;
        $("[node-type=floor]").click(function() {
            $(this).addClass("active").siblings().removeClass("active");
            _index = $(this).index() + 1;
            //通过拼接字符串获取元素，再取得相对于文档的高度
            var _top = $("#ceng" + _index).offset().top;
            console.log($("#ceng4").offset().top);
            console.log($(".floor-list").offset().top);
            //scrollTop滚动到对应高度
            $("body,html").animate({
                scrollTop: _top
            }, 1500, 'easeInOutQuint');
        ...
        $('.zx-Btn').click(function() {
            $("[node-type=floor]").eq(2).addClass("active").siblings().removeClass("active");
            $("body,html").animate({
                scrollTop: $("#ceng3").offset().top
            }, 1500, 'easeInOutQuint');
        });

        //页码切换 样式
        var totalpageNumM = Math.ceil(2 / 4);
        $("#pagination").pagination({
            currentPage: 1,
            totalPage: totalpageNumM,
            isShow: false,
            count: 6,
            prevPageText: "← 上一页",
            nextPageText: "下一页 →",
            callback: function(current) {
                //console.log(current);
                $('.b-center-box').find('ul').fadeOut(300);
                $('.b-center-box').find('ul').eq( current-1).fadeIn(300);
            }
        });
        ...
        $("#pagination2").pagination({
            currentPage: 1,
            totalPage: totalpageNumB,
            isShow: false,
            count: 6,
            prevPageText: "← 上一页",
            nextPageText: "下一页 →",
            callback: function(current) {
                $('.question-img').fadeOut(300);
                setTimeout(function () {
                    $('.question-img.img_' + current).fadeIn(300);
                },300)
