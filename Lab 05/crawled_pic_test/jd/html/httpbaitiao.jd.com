...
<head>
    ...
    <meta name="description" content="白条是京东金融推出的“先消费，后付款”的全新支付方式，在京东商城购物时打白条即可延后或分期付款购买手机等商品；除了在京东商城，可以打白条租房、装修、学车、培训等；白条还可以实现线上、线下闪付功能，凡开通apple pay、华为pay、小米pay，有银联pos机的地方都可以打白条；最后白条还可以通过扫码付的形式完成支付。了解更多京东白条分期优惠券等信息，请访问京东白条首页。"/>
    <meta name="Keywords" content="京东白条首页,京东白条分期付款，京东金融、白条首页、白条分期付款"/>
    <title>白条首页 - 京东金融旗下的“先消费，后付款”的支付方式</title>
    ...
    <link rel="stylesheet" type="text/css" href="//static.360buyimg.com/finance/consumer/baitiao/index/3.4.2/css/common.css">
    <link rel="stylesheet" type="text/css" href="//static.360buyimg.com/finance/consumer/baitiao/index/3.4.2/css/index.css">
    <script>
        window.jrBase = {
            navId: 'nav-baitiao',
            navSubId: 'nav-subBaitiao',
            footerFix: true,
            headerFix: true,
            // 侧边工具栏
            sidebar: true,
...
<div id="container">
    ...
    <div class="banner" id="banner" data-index="1">
        <!--背景图-->
        <a href="//www.baitiao.com" target="_blank" class="background" clstag="jr|keycount|newbthome|dabeijingtu">
            <div class="mask1"></div>
            <div class="mask2"></div>
            <!--<div class="left"></div>
            <div class="right"></div>
            <div class="huoju"></div>
            <div class="heping"></div>-->
        </a>
        <!--内容区-->
        <div class="content">
            <!--左侧用户信息-->
            ...
            <div class="rightBox">
                ...
                <div class="tips">
                    ...
                    <a href="//jrhelp.jd.com/show/getTrdTabList-610" target="_blank" class="help" clstag="jr|keycount|newbthome|help">
                        <span class="mask"></span><i></i><em>帮助</em>
                    </a>
                    <a href="javascript:void (0);" class="app" clstag="jr|keycount|newbthome|yidongapp">
                        <span class="mask"></span><i></i><em>提额</em>
                    </a>
    ...
    <!--打白条-->
    <div class="item dbt" id="dbt" node-type="item">
        <div class="item_content clearfix">
            <div class="sideTitle">
                <h3>打白条</h3>
                <span class="privileged"><em>想要占便宜</em><em class="last">快来打我呀</em></span>
                <div class="yhj" node-type="dbt-yhj"></div>
            </div>
            <div class="commodities">
                <div class="left clearfix" node-type="leftProduct"></div>
                <div class="between clearfix" node-type="dbtBetween"></div>
                <div class="right clearfix" node-type="rightList"></div>
            </div>
        </div>
    </div>
    <!--小白屋-->
    <div class="item xbw" id="xbw" node-type="item">
        <div class="item_content clearfix">
            <div class="sideTitle" node-type="xbwSideTitle">
                <h3>时光杂货店</h3>
                <span class="privileged"><em>白条免息神店</em></span>
            </div>
            <div class="commodities">
                <div class="xbwActive" node-type="xbwActive"></div>
                <div class="bh" node-type="xbwBh">
                    <h3 class="title">腔调好物</h3>
                </div>
                <div class="recommend" node-type="xbwRecommend"></div>
            </div>
        </div>
    </div>
    <!--享免息-->
    <div class="item xmx" id="xmx" node-type="item">
        <div class="item_content clearfix" node-type="xmxContent">
            <div class="sideTitle">
                <h3>享免息</h3>
                <span class="privileged"><em>分期享免息</em><em class="last">想要尽管说</em></span>
                <div class="weixin_code"><img src="//static.360buyimg.com/finance/consumer/baitiao/index/3.4.0/css/i/WXCode.jpg"/></div>
                <p class="desc">还是不能满足你？<br/>去微信告诉白条君！</p>
                <a href="javascript:void (0);" class="activeRule" node-type="mxRule" clstag="jr|keycount|newbthome|xmxguize">免息规则&nbsp;<i class="gt">&gt;</i></a>
            </div>
            <div class="commodities">
                <!--投票-->
                <div class="vote" node-type="vote">
                ...
                <!--免息商品列表-->
                <div class="mxList" node-type="mxList">
                    <!--星期列表-->
                    <ul class="week clearfix" node-type="bar">
                        <li class="first">周一</li>
                        <li>周二</li>
                        <li>周三</li>
                        <li>周四</li>
                        <li>周五</li>
    ...
    <!--有好货-->
    <div class="item yhh" id="yhh" node-type="item">
        <div class="item_content clearfix">
            <div class="primaryTitle clearfix">
                <h3 class="clearfix">有好货<span>精选好货别错过</span></h3>
            </div>
            <div class="otherProducts" node-type="otherProducts"></div>
        </div>
    </div>
    <!--爱旅游-->
    <div class="item aly" id="aly" node-type="item">
        <div class="item_content clearfix">
            <div class="primaryTitle clearfix">
                <h3>爱旅游<span>旅游，一张白条就够了</span></h3>
                <div class="readMore">
                    <a href="//sfy.jd.com/" target="_blank" clstag="jr|keycount|newbthome|alymore">查看更多&nbsp;<i class="gt">&gt;</i></a>
                </div>
            </div>
            <div class="otherProducts clearfix" node-type="travel"></div>
        </div>
    </div>
    <!--住好房-->
    <div class="item ajbt" id="ajbt" node-type="item">
        <div class="item_content clearfix">
            <div class="primaryTitle clearfix">
                <h3 class="clearfix">住好房<span>租房装修，轻松月付</span></h3>
            </div>
            <div class="otherProducts" node-type="zhf"></div>
        </div>
    </div>
    <!--换钢镚-->
    <div class="item jdgb" id="jdgb" node-type="item">
        <div class="item_content clearfix">
            <div class="primaryTitle clearfix">
                <h3 class="clearfix">换钢镚<span>1个钢镚相当于1元人民币</span></h3>
            </div>
            <div class="otherProducts" node-type="hgbProducts"></div>
        </div>
    </div>
    <!--小白卡-->
    <div class="item lmk" id="lmk" node-type="item">
        <div class="item_content clearfix">
            <div class="primaryTitle clearfix">
                <h3 class="clearfix">小白卡<span>高颜值会赚钱的信用卡</span></h3>
            </div>
            <div class="otherProducts" node-type="xbkProducts"></div>
        </div>
    </div>
    <!--手机白条-->
    <div class="item sjbt" id="sjbt" node-type="item">
        <div class="item_content clearfix">
            <div class="primaryTitle clearfix">
                <h3 class="clearfix">手机白条<span>移动白条，玩转生活</span></h3>
            </div>
            <div class="otherProducts" node-type="sjbtProducts"></div>
        </div>
    </div>
</div>
...
<script src="//static.360buyimg.com/finance/consumer/baitiao/index/3.4.4/js/common/main.js"></script>
<script>
    seajs.use("script/entry");
</script>
<script type="text/javascript">
    seajs.use('common/unit/xPromotion/1.0.0/xPromotion', function (xPromotion) {
        // 金融通用顶部广告位
        new xPromotion({
            ad_id: '1774480',
            batchCount: '1',
...
<script type='text/javascript'>
    var _jaq = _jaq || [];
    _jaq.push(['_setAccount', 'UA-JR-BT']);
    _jaq.push("home");
    (function() {
