...
<head>
    ...
    <meta name="description" content="房抵贷是京东金融及相关合作机构联合推出的房产抵押贷款产品，有房就能贷款，手续简单在线申请，支持信用贷和抵押贷，贷款金额可高达1000万。当前可为北京、上海、深圳、杭州、郑州地区提供服务。"/>
    <meta name="Keywords" content="房屋抵押贷款,房屋抵押借款,住房抵押贷款,信用贷,京东金融/"/>
    <title>京东房抵贷|房产抵押贷款 - 京东金融</title>
    ...
    <link rel="stylesheet" type="text/css" href="//static.360buyimg.com/finance/consumer/pledgeLoan/pledgeHouse/1.0.0/css/index.css">
    <script>
        window.jrBase = {
            navId: 'nav-baitiao',
            navSubId: 'nav-dzyd',
            ...
            sidebar: true,
            // 问卷反馈url id为业务线配置
            serviceUrl:'//jtalk.jd.com/index.htm?initSource=02',
...
<!--header end-->
<!--banner start-->
<div id="j_banner" class="pledge-banner">
    <div class="bannerBox">
        <div class="btLogo"></div>
        <div class="bigLogo zoomIn">
            <img src="//static.360buyimg.com/finance/consumer/pledgeLoan/pledgeHouse/1.0.0/css/i/bigLogo.png" alt=""/>
        </div>
        <div class="ewmBox flipInY">
            <img src="//static.360buyimg.com/finance/consumer/pledgeLoan/pledgeHouse/1.0.0/css/i/ewm.png" alt=""/>
        </div>
    </div>
</div>
<!--banner  end-->
<div class="pledge-content1">
    <h2>什么是房抵贷？</h2>
    <p class="eFont">WHAT IS THE FANG DI DAI ?</p>
    <p class="pFont">房抵贷是京东金融及相关合作机构联合推出的房产抵押贷款产品。整合各大金融机构资源，为您快速办理贷款业务。目前可为北京、上海、深圳、杭州、郑州地区提供服务。</p>
    <div class="tlBg"></div>
    <div class="brBg"></div>
</div>
<div class="pledge-content2">
    <h2>房抵贷的优势</h2>
    <p class="eFont">THE ADVANTAGES OF THE FANG DI DAI</p>
    <div class="fourBg clearfix">
        <div class="bottom fl">
            <h3>简</h3>
            <p>手续简单，在线申请，专业的金融机构办理业务。</p>
        </div>
        <div class="top fl">
            <h3>优</h3>
            <p>服务更优，专属金融通道，一对一专业贷款服务。</p>
        </div>
        <div class="bottom fl">
            <h3>高</h3>
            <p>贷款金额超高，可高达1000万,通过率高达93%。</p>
        </div>
        <div class="top fl">
            <h3>智</h3>
            <p>智能优选，我们帮你挑，一键直达定制化金融产品。</p>
        </div>
    </div>
</div>
<div class="pledge-content3">
    <h2>房抵贷申请流程</h2>
    <p class="eFont">HOW TO APPLY FOR THE FANG DI DAI</p>
    <div class="w1200">
        <div class="stepBg step1">
            <i></i>
            <p>1.我要申请</p>
        </div>
        <div class="JT"></div>
        <div class="stepBg step2">
            <i></i>
            <p>2.业务受理</p>
        </div>
        <div class="JT"></div>
        <div class="stepBg step3">
            <i></i>
            <p>3.审批通过</p>
        </div>
        <div class="JT"></div>
        <div class="stepBg step4">
            <i></i>
            <p>4.贷款发放</p>
        </div>
    </div>
...
<div class="questionBox">
    ...
    <ul>
        <li>
            <h4>Q1：什么是房抵贷？</h4>
            <p>房抵贷是京东金融及相关合作机构联合推出的房产抵押贷款产品，支持信用贷和抵押贷。</p>
        </li>
        <li>
            <h4>Q2：房抵贷业务开展城市有哪些？</h4>
            <p>目前仅支持北京、上海、深圳、杭州、郑州，抵押房产需位于以上5个城市，其他城市可提交申请，待开放城市之后，将优先为您办理房抵贷业务。</p>
        </li>
        <li>
            <h4>Q3：房抵贷对申请人有哪些要求？</h4>
            <p>年龄要求18-60周岁，具中国国籍（不含港、澳、台居民），信用记录良好，企业、个人都可申请。</p>
        </li>
        <li>
            <h4>Q4：申请到贷款发放需要多长时间？</h4>
            <p>最短可在一周之内完成贷款的审批和发放。</p>
        </li>
        <li>
            <h4>Q5：更多问题找谁咨询？</h4>
            <p>如果您对房抵贷还有疑问，请您联系京东金融客服专线95118（周一至周日9:00-22:00）。</p>
        </li>
    </ul>
</div>
