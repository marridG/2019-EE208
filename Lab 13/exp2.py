...
MODEL_PATH="ex2-outputs/"
LOAD_TRAINED=0  # 0=None, 1=Part, 2=All
TEST=True
...
if 1==LOAD_TRAINED:
    ...
    restore_model_path = 'ex2-outputs/ex2_model.pth'
...
def train(epoch):
    ...
    torch.save(model.state_dict(), MODEL_PATH+'ex2_model_%d_acc_%f.pth'%(epoch,float(correct)/total))
...
if 0==LOAD_TRAINED or 1==LOAD_TRAINED:
